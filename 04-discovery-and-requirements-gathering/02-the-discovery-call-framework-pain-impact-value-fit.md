---
title: The Discovery Call Framework (Pain → Impact → Value → Fit)
...
```mermaid
flowchart LR
    A["Pain<br/>What's actually broken?"] --> B["Impact<br/>What does it cost — time, money, risk?"]
    B --> C["Value<br/>What's it worth to fix?"]
    C --> D["Fit<br/>Can we solve it, and who decides?"]
```
