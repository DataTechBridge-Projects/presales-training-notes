---
title: Collaboration with Sales & Delivery
...
```mermaid
flowchart LR
    A[Client conversation] --> B[Pre-sales validates with delivery]
    B --> C[Estimate & SOW drafted]
    C --> D[Deal signed]
    D --> E[Formal handoff to delivery]
```
