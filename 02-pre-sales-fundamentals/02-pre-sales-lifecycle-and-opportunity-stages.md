---
title: Pre-Sales Lifecycle and Opportunity Stages
...
```mermaid
flowchart TD
    A[Qualification] --> B[RFx Intake / Opportunity Review]
    B --> C[Discovery]
    C --> D[Solutioning & Scoping]
    D --> E[Estimation & Pricing]
    E --> F[Proposal / RFx Response]
    F --> G[Demo & Evaluation]
    G --> H[Negotiation & Contracting]
    H --> I[Closure & Handoff to Delivery]
```
